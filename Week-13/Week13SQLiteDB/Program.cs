...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        {
            SQLiteConnection connection = new SQLiteConnection("Data Source=Customersdb.db; Version = 3; New = True; Compress = True;");

            try
            {
                connection.Open();
                Console.WriteLine("DB is found.");
            }
            catch
            {
                Console.WriteLine("DB is not found.");
            }
